<template>
  <div>
      <div class="flex mt-8 mb-24" @click="$router.push('/mail')">
          ...
          <h1 class="text-white text-[25px] ml-[137px] font-bold font-poppins">Email</h1>
      </div>
      ...
      <div class="text-white text-[10px] ml-10 mr-10 text-center font-poppins">Never disclose the password of this email address to a third
          party, this could risk hacking your INDE account!</div>

      <div class="flex  mb-3  ">
          <button @click="saveEmail"
              class="px-2.5 border-none rounded-full bg-red-500 text-white cursor-pointer w-[120px] font-poppins mx-auto font-bold mt-5 pt-2 pb-2 text-[18px]  "
