<template>
    ...
    <div
        class="w-[390px] h-[40px] px-2.5 py-[5px] bg-custom-gray rounded-[20px] gap-[3px] inline-flex text-white ml-5 mb-3">
        <input type="text" id="newmail" class="float-left text-white bg-transparent w-full mt-0.5 ml-2" placeholder="Enter your new email">
        <div class="w-6 h-6 bg-transparent relative mt-1 ">
        </div>
    </div>
