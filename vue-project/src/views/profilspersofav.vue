<template>
    ...
    <div class="flex justify-center items-center gap-12 mb-1 mt-4">
        ...
        <img class="h-6 w-6" src="../assets/favoris.svg" alt="">

    </div>

    <div class="barre bg-white mb-2 w-11 ml-[270px]"></div>
...
export default {
    ...
    methods: {
        ...
        async deletetweet(data) {
            ...
            const id_user = apiResponse.user.id;  console.log("id_user de pp:", data.id);
        ...
        async fetchData() {
            try {
                ...
                const response = await fetch(`http://localhost:1337/api/posts?populate=*&filters[$and][0][fav][id][$eq]=${id_user}`);
