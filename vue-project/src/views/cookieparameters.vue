<template>
    ...
    <div
        class="w-[360px] text-white text-[11px] border-none rounded-full bg-custom-gray rounded-2xl  ml-9 mt-9 px-6 p-2 text-center ">
    ...
    <div class=" text-white text-[10px] border-none rounded-full mt-2 px-6 p-2 text-center "> These cookies only concern the
    ...
    <div class="flex items-center justify-center mt-5">
        <button class="rounded-2xl cursor-pointer pl-2.5 pr-2.5 text-[20px] pt-1 pb-1 bg-red-500 ml-1 text-align mt-10"
