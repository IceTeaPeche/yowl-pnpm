<template>
    <div>
        ...
        <div class="text-white text-[10px] ml-10 mr-10 text-center font-poppins">Never disclose the password of this username address to a third
            party, this could risk hacking your INDE account!</div>

        <div class="flex  mb-3  ">
            <button @click="saveUsername"
                class="px-2.5 border-none rounded-full bg-red-500 text-white cursor-pointer font-poppins w-[120px] mx-auto font-bold mt-5 pt-2 pb-2 text-[18px]  "
